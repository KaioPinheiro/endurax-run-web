...
export function volumesDisponiveisPorObjetivo(objetivo, experienciaCorrida) {
  ...
  if (experiencia === "1 a 3 anos" && objetivo === "Primeiros 10 km") {
    return volumesFiltrados.filter((volume) =>
      !["Menos de 10 km", "40-60 km"].includes(volume));
  }
  ...
  if (experiencia === "1 a 3 anos" && objetivo === "Melhorar tempo nos 5 km") {
    return volumesFiltrados.filter((volume) => volume !== "Menos de 10 km");
  }

  if (experiencia === "1 a 3 anos" && objetivo === "Melhorar tempo nos 10 km") {
    return volumesFiltrados.filter((volume) => volume !== "40-60 km");
  }
